      ...
      *----------------------------------------------------------------*
       ...
       01  WS-ERRMSGS.
           ...
           05 WS-PRESS-F2                        PIC X(31) VALUE
              'PRESS PF2 TO APPROVE THE TICKET'.
           05 WS-PRESS-F5                        PIC X(53) VALUE
             'TICKET APPROVAL ABORTED. ENTER TICKET AND PRESS ENTER'.
           05 WS-TICKET-APPROVED                 PIC X(54) VALUE
             ...
             WHEN DFHPF2
                  EVALUATE TRUE
                    ...
                    WHEN WS-STATE = 2
                         ...
                         MOVE 'APPROVED' TO STATO
                         MOVE USERID TO UPDTBYO
                         MOVE 'TICKET APPROVED' TO UPDREM1O
                         MOVE 3 TO WS-STATE
                         PERFORM 600-MOVE-DATA-TO-COMMAREA
